...
LevSelTextLoad:
	...
	textpos	= ($40000000+(($E210 and $3FFF) shl 16)+(($E210 and $C000) shr 14))
...
EndOfRom:
		...
		; END ; TODO: What is this and why does it exist?
