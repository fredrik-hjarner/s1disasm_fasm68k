...
ptr_musend: ; TODO: Should this be auto-fixed by `compat_colonless_labels`?
; ---------------------------------------------------------------------------
...
ptr_flgend: ; TODO: Shouldn't `compat_colonless_labels` fix this?
; ===========================================================================
; ---------------------------------------------------------------------------
...
FMInstrumentOperatorTable_End: ; TODO: Shouldn't `compat_colonless_labels` fix this?
; byte_72D2C:
FMInstrumentTLTable:
...
FMInstrumentTLTable_End: ; TODO: Shouldn't `compat_colonless_labels` fix this?
; ===========================================================================
; loc_72D30:
cfModulation:
...
ptr_sndend: ; TODO: Shouldn't `compat_colonless_labels` fix this?
...
ptr_specend: ; TODO: Shouldn't `compat_colonless_labels` fix this?
...
; ---------------------------------------------------------------------------
		...
		if ($ and $7FFF)+Size_of_SegaPCM>$8000
			align $8000
		endc
SegaPCM:	incbin	"sound/dac/sega.pcm"
SegaPCM_End: ; TODO: Shouldn't `compat_colonless_labels` fix this?
		even
